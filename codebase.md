...
```ts
export const STREAM_API_KEY = "pcvjbntz7tfy"
export const STREAM_API_SECRET = "vgvu27ejxqbq2sqaq8p5qx7yghb2nppt6vk2px3sy573gz482wzurs8juasgqtjk"
```
...
```
postgres://postgres.mmarjzhissgpyfwxudqd:[YOUR-PASSWORD]@aws-0-ca-central-1.pooler.supabase.com:6543/postgres
```
